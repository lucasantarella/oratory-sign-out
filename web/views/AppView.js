...
define([
  ...
  return Marionette.View.extend({
    ...
    template: _.template('' +
      '<div class="container no-gutters-xs no-gutters-sm no-gutters-md no-gutters-lg no-gutters-xl">' +
      ...
      '</div>' +
      '<div id="main"></div>' +
      '<div class="footer w-100" style="height: 10% !important;"><div class="container no-gutters-xs no-gutters-sm no-gutters-md no-gutters-lg no-gutters-xl h-100 w-100 bg-faded py-3 d-flex align-items-center">' +
